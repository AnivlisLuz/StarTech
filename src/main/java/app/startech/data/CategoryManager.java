...
public class CategoryManager {
    public Category secuencia = new Category(1, "Secuencia de números","https://github.com/AnivlisLuz/StarTech/releases/download/gifs/Secuencia.gif", true, new Level[]{
    ...
    public Category suma = new Category(2, "Suma","https://github.com/AnivlisLuz/StarTech/releases/download/gifs/Suma.gif", false, new Level[]{
    ...
    public Category resta = new Category(3, "Resta","https://github.com/AnivlisLuz/StarTech/releases/download/gifs/Resta.gif", false, new Level[]{
    ...
    public Category multiplicacion = new Category(4, "Multiplicación","https://github.com/AnivlisLuz/StarTech/releases/download/gifs/Multiplicacion.gif", false, new Level[]{
    ...
    public Category division = new Category(5, "División","https://github.com/AnivlisLuz/StarTech/releases/download/gifs/Division.gif", false, new Level[]{
