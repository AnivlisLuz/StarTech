...
public class CategoryManager {
    ...
    public Category sopaResultado = new Category(5, "Sopa de Resultados", false, new Level[]{
    ...
    public Category crucigrama = new Category(5, "Crucigramas", false, new Level[]{
    ...
    public Category combinado = new Category(5, "Combinados", false, new Level[]{
